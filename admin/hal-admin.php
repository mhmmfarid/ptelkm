...
if ($result) {
    ...
    $gambar_path = ($gambar && file_exists('../uploads/' . $gambar)) ? 'uploads/' . $gambar : 'uploads/default-avatar.png';
...
<body>
  ...
  <nav class="navbar navbar-expand-lg">
    <div class="container-fluid">
      ...
      <!-- Tombol Toggler untuk Navbar (versi mobile) -->
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link f" href="#alat" id="link-alat">Tools</a>
          </li>
          <li class="nav-item">
            <a class="nav-link a" href="#list" id="link-list">Device</a>
          </li>
        </ul>
    ...
    <div class="profile-info">
      ...
      <p class="text-muted mt-1 mb-0" style="font-size: 0.9em;"><strong>Tanggal Lahir:</strong> <?php echo htmlspecialchars($data['tanggal_lahir']); ?></p>
        ...
        <div class="achievement-item">
          <li><a class="dropdown-ites" href="../admin/data-sto.php"><i class="fa-solid fa-screwdriver-wrench"></i> Data Alat Produksi</a></li>
        </div>  
        <!-- Achievements Section -->
        <div class="achievement-item">
