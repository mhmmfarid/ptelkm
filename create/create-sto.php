...
<body>
    <div class="container mt-5">
        ...
        <ul class="stepper list-unstyled">
            ...
            <div class="col-md-9 form-section">
                ...
                <h3 class="">Create New STO</h3>
                <form action="../simpan/simpan-sto.php" method="POST">
    <!-- ID STO -->
    <div class="mb-3">
        <label for="id_sto" class="form-label">ID STO</label>
        <input type="text" class="form-control" id="id_sto" name="id_sto" placeholder="ID STO" required>
    </div>
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="spesifikasi" name="spesifikasi" placeholder="Kode Jenis" required>
        </div>
        <div class="col-md-6">
            <label for="kode_area" class="form-label">Kode Area</label>
            <input type="text" class="form-control" id="kode_area" name="kode_area" placeholder="Kode Area" required>
        </div>
    </div>
